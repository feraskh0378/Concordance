<%@ page import="com.concordance.model.Song, java.util.ArrayList, java.util.List, java.util.Map, java.util.HashMap"  contentType="text/html;charset=UTF-8" language="java" %>
				...
				<table id="SongsTable">
	 					...
	 					<tr>
	 					    <td><input type="txt" id="Id"  value=""            oninput="FilterSongsTable('SongsTable',0)"></td>
	    					<td><input type="txt" id="Title"  value=""            oninput="FilterSongsTable('SongsTable',0)"></td>          
	    					<td><input type="txt" id="Poet" value=""              oninput="FilterSongsTable('SongsTable',0)"></td>
	    					<td><input type="txt" id="Composer" value=""          oninput="FilterSongsTable('SongsTable',0)"></td>
	    					<td><input type="txt" id="NumberOfVerses"    value="" oninput="FilterSongsTable('SongsTable',0)"></td>
	    					<td><input type="txt" id="NumberOfLines"    value=""  oninput="FilterSongsTable('SongsTable',0)"></td>
	    					<td><input type="txt" id="NumberOfWords"    value=""  oninput="FilterSongsTable('SongsTable',0)"></td>
	    				</tr>     
				        ...
				        %>
				         ...
				         <tr onclick="getSongWordsTable('SongsWordsTable',<%= song.getId() %>,'<%= song.getTitle() %>',0)">
					       ...
					       %>	
					        ...
					        <% if(inputStartIndex != 0) { %>
				      			<td colspan=3 >  		
				 		 			<button class="circle-btn" onclick="getSongs(<%= inputStartIndex - MaxInPage%>)">&lt;</button>
								</td>
							<% } else { %>
								<td colspan=3 >  		
